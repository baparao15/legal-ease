...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert legal analyst. Summarize the following legal document and extract the key points.

Document:
{{{documentText}}}

Do not identify risks or risky clauses in your response. Only provide the summary and key points.
`,
});
